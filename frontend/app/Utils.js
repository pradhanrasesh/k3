...
export function getRedactedFilename(original) {
  ...
  try {
    ...
    console.log("[Utils] getRedactedFilename pattern from localStorage:", pattern);
  } catch {
    // keep default
    console.log("[Utils] getRedactedFilename using default pattern");
  }
  ...
  console.log("[Utils] getRedactedFilename result:", out);
  return out;
}
